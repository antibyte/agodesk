...
const TRANSLATIONS = {
  ...
  es: {
    ...
    "settings.speech.asrStatus.ready.sense_voice_int8":
      "Modelo SenseVoice encontrado y listo.",
    ...
    "settings.speech.ttsTest.success":
      "Reproducción iniciada ({backend}, voz: {voice}).",
  ...
  zh: {
    ...
    "settings.speech.localAsrModel.whisper_small_de":
      "Whisper Small（推荐用于欧洲语言）",
    "settings.speech.localAsrModel.sense_voice_int8":
      "SenseVoice（推荐用于日语和中文）",
    "settings.speech.localAsrModel.whisperRecommendedHint":
      "对于所选应用语言，推荐使用 Whisper。",
    "settings.speech.localAsrModel.senseVoiceRecommendedHint":
      "当应用语言为日语或中文时，推荐使用 SenseVoice。",
    "settings.speech.asrStatus.ready.sense_voice_int8":
      "已找到 SenseVoice 模型并可供使用。",
    ...
    "settings.speech.ttsTest.success":
      "已开始播放（{backend}，语音：{voice}）。",
    "settings.speech.ttsTest.failed": "测试失败：{message}",
    "settings.speech.ttsTest.edgeHint":
      "Edge TTS 需要互联网。选择 Edge TTS 时，Piper 备用已禁用。",
    "settings.speech.ttsTest.piperHint":
  ...
  ja: {
    ...
    "settings.speech.localAsrModel.whisper_small_de":
      "Whisper Small（欧州言語向け推奨）",
    "settings.speech.localAsrModel.sense_voice_int8":
      "SenseVoice（日本語・中国語向け推奨）",
    "settings.speech.localAsrModel.whisperRecommendedHint":
  ...
  sv: {
    ...
    "settings.speech.asrStatus.ready.sense_voice_int8":
      "SenseVoice-modell hittad och redo.",
    ...
    "settings.speech.ttsTest.success":
      "Uppspelning startad ({backend}, röst: {voice}).",
  ...
  no: {
    ...
    "settings.speech.asrStatus.ready.sense_voice_int8":
      "SenseVoice-modell funnet og klar.",
    ...
    "settings.speech.ttsTest.success":
      "Avspilling startet ({backend}, stemme: {voice}).",
  ...
  da: {
    ...
    "settings.speech.asrStatus.ready.sense_voice_int8":
      "SenseVoice-model fundet og klar.",
    ...
    "settings.speech.ttsTest.success":
      "Afspilning startet ({backend}, stemme: {voice}).",
  ...
  hi: {
    ...
    "settings.speech.ttsTest.success":
      "प्लेबैक शुरू ({backend}, आवाज़: {voice})।",
